...
export const ROLE_IDS = {
  OTHERS: ROLE_IDS_OTHERS,
  SPIRAL_ABYSS: ROLE_IDS_SPIRAL_ABYSS,
  REPUTATION: ROLE_IDS_REPUTATION,
  CROWN: ROLE_IDS_CROWN,
} as const;
...
const SPIRAL_ABYSS_ROLES = [
  ...
  },
  {
    ...
    value: ROLE_IDS.SPIRAL_ABYSS.ABYSSAL_CONQUEROR,
  },
  {
    name: "Abyssal Sovereign ⚔️",
    value: ROLE_IDS.SPIRAL_ABYSS.ABYSSAL_SOVEREIGN,
  },
];
